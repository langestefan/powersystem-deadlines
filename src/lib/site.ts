 ...
 */
export const SITE_URL = 'https://langestefan.github.io/powersystems-deadlines';
...
export const SITE_TITLE = 'Power Systems Deadlines';
export const SITE_DESCRIPTION =
  'Countdown timers and subscribable calendar feeds for power system conference deadlines.';
export const REPO_URL = 'https://github.com/langestefan/powersystems-deadlines';
